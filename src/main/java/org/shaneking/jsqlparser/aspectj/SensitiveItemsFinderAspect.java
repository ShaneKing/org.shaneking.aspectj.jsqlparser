...
public class SensitiveItemsFinderAspect {
  ...
  //0
  @Around("@annotation(org.shaneking.jsqlparser.annotation.SensitiveItemsFinderAlias)")
  ...
  //2
  @Around("@annotation(org.shaneking.jsqlparser.annotation.SensitiveItemsFinderAsterisk)")
